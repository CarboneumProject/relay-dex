...
describe('feeProcessor', function () {
  ...
  it('should able to calculate fee for 1 order with same amount and lower price and no fee will paid', async function () {
    let openTrades = [
      {
        'id': 1,
        'order_time': '2019-03-05T06:59:18.000Z',
  ...
  it('should able to calculate fee for 1 order then sell 1st order at cost and sell 2nd order for better price.', async function () {
    let openTrades = [
      {
        'id': 1,
        'order_time': '2019-03-05T06:59:18.000Z',
  ...
  it('should able to calculate fee for 2 orders different price and amount then sell 1 order for better price.', async function () {
    let openTrades1 = [
      {
        'id': 1,
        'order_time': '2019-03-05T06:59:18.000Z',
