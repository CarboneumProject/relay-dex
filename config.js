const providers = {
  rinkeby: {
    ...
    relayWalletIDEX: '0x2e404de9faebc4b94d7e21366bdf96534cd76585',
    radarrelay_url: '',
    openrelay_url: ''
  },
...
function getProvider(network){
  return providers[process.env.NETWORK || network || 'kovan']
}


module.exports = {
  getProvider:getProvider,
  mnemonic: process.env.MNEMONIC || 'river upper raven knee they cook exist feature october budget retreat intact', //Your mnemonic
};
